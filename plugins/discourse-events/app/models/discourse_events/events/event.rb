  ...
  module Events
    class Event < ActiveRecord::Base
      ...
      def allowed_livestream_url?
        DiscourseEvents::Livestream::AllowedHosts.allows_url?(livestream_url)
      end
      ...
      def create_livestream_chat_channel
        ...
        DiscourseEvents::Livestream.handle_topic_chat_channel_creation(post.topic)
      end
      ...
      def enqueue_warm_livestream_onebox
        ...
        if !saved_change_to_livestream? && !saved_change_to_location? && !saved_change_to_url?
          return
        end
      ...
      def on_going_event_invitees
        ...
        invitees.where(status: DiscourseEvents::Events::Invitee.statuses[:going])
      end
      ...
      def unfollow_livestream_chat(user_ids)
        ...
        User
          ...
          .find_each do |user|
            ...
            DiscourseEvents::Livestream.publish_livestream_chat_status(membership, user:)
          end
      end
      ...
      def chat_channel_sync
        if chat_enabled && chat_channel_id.blank? && post.last_editor_id.present?
          DiscourseEvents::Events::ChatChannelSync.sync(
            self,
      ...
      def is_zoom_livestream?
        ...
        DiscourseEvents::Livestream::ZoomUrlParser.zoom_url?(livestream_url)
      end
      ...
      def calculate_next_recurring_date
        ...
        DiscourseEvents::Events::RRuleGenerator.generate(
